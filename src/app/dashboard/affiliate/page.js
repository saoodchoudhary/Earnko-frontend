...
export default function AffiliateToolsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F8FB]">
      ...
      {/* ✅ Premium Top App Bar */}
      <section className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-500 text-white flex items-center justify-center shadow-md">
                <Zap className="w-5 h-5" />
              </div>
              <div>
                <div className="text-[11px] text-gray-500 uppercase tracking-wider">Affiliate Tools</div>
                <h1 className="text-lg sm:text-xl font-extrabold text-gray-900">
                  Link Generator
                </h1>
                <p className="text-xs sm:text-sm text-gray-500">
                  Create & track single or bulk affiliate links
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={clearAll}
                className="px-3 py-2 rounded-lg border border-gray-200 bg-white text-gray-700 text-xs sm:text-sm font-semibold hover:bg-gray-50 transition"
              >
          ...
          {/* Tabs */}
          <div className="mt-3 inline-flex rounded-xl border border-gray-200 bg-gray-50 p-1 text-xs sm:text-sm">
            <button
              className={`px-4 py-2 rounded-lg font-semibold ${!isMulti ? 'bg-white text-blue-700 shadow-sm' : 'text-gray-600'}`}
              onClick={() => setIsMulti(false)}
            >
              Single
            </button>
            <button
              className={`px-4 py-2 rounded-lg font-semibold ${isMulti ? 'bg-white text-blue-700 shadow-sm' : 'text-gray-600'} flex items-center gap-2`}
...
function TelegramFloatingButton({ href, onClose }) {
  ...
  return (
    <div className="fixed z-50 right-3 bottom-20 sm:right-4 sm:bottom-6">
      <div className="relative">
        <a
          href={href}
          target="_blank"
          rel="noopener noreferrer"
          className="group relative flex items-center gap-2 px-3 py-2 rounded-full bg-[#229ED9] text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5 active:translate-y-0"
        >
          <FaTelegramPlane className="w-4 h-4" />
          <span className="text-xs font-medium inline">Telegram Bot</span>
        </a>
        
        <button
          onClick={onClose}
          className="absolute -top-[6px] -right-[6px] w-5 h-5 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-gray-100 transition-colors"
          aria-label="Close"
        >
