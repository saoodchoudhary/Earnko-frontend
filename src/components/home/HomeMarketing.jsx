// components/home/HomeMarketing.js - Enhanced Marketing Page
'use client';
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-96 bg-gradient-to-r from-blue-100/10 to-cyan-100/10 blur-3xl"></div>
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="lg:w-1/2">
                {/* Premium Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-200/50 mb-6 shadow-sm backdrop-blur-sm">
                ...
                <div className="flex flex-wrap gap-4 mt-8">
                  <button
                    ...
                    className="px-8 py-3.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-blue-500/30 transform hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-3 group"
                  >
                  ...
                  <Link 
                    href="/demo"
                    className="px-8 py-3.5 bg-white border-2 border-gray-200 text-gray-800 font-semibold rounded-xl hover:border-blue-300 hover:shadow-lg transition-all duration-300 flex items-center gap-3 group"
                  >
                ...
                <div className="mt-10 grid grid-cols-3 gap-4">
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200/50 hover:shadow-lg hover:border-blue-200 transition-all duration-300">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">No Fees</div>
                      <div className="text-sm text-gray-500">Free to join</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200/50 hover:shadow-lg hover:border-blue-200 transition-all duration-300">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-50 to-cyan-50 flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200/50 hover:shadow-lg hover:border-blue-200 transition-all duration-300">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center">
                      <Zap className="w-6 h-6 text-amber-600" />
                    </div>
                    <div>
                      <div className="font-bold text-gray-900">24h Payout</div>
              ...
              <div className="lg:w-1/2">
                <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200/50 rounded-3xl p-8 shadow-2xl shadow-blue-500/10 backdrop-blur-sm">
                  <div className="text-center mb-8">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-400 flex items-center justify-center mx-auto mb-4 shadow-lg">
                      <TrendingUp className="w-8 h-8 text-white" />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900">Real-time Affiliate Stats</h3>
                    <p className="text-gray-600 mt-2">See what our community is achieving</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    {stats.map((stat, index) => (
                      <div 
                        key={index} 
                        className="bg-gradient-to-br from-white to-gray-50 border border-gray-200/50 rounded-xl p-4 hover:shadow-lg hover:border-blue-200 transition-all duration-300"
                      >
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100/50">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-dashed border-blue-300 rounded-lg text-gray-600 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 text-left group"
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-sm">Paste any product URL...</span>
                        <div className="px-3 py-1 bg-gradient-to-r from-blue-500 to-cyan-400 text-white text-xs font-semibold rounded-full group-hover:scale-105 transition-transform">
                          Generate
                        </div>
                      </div>
                    </button>
            ...
            <div className="mt-20 pt-10 border-t border-gray-200/50">
              <p className="text-center text-gray-500 mb-6 text-sm font-medium">TRUSTED BY THOUSANDS OF AFFILIATES</p>
              <div className="grid grid-cols-2 md:grid-cols-6 gap-8 opacity-70">
                {['Amazon', 'Flipkart', 'Myntra', 'Ajio', 'Nykaa', 'Swiggy'].map((brand, i) => (
                  <div key={i} className="text-center">
                    <div className="text-2xl font-bold text-gray-300">{brand}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50/50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-200/50 mb-4">
              ...
              {products.map((product, index) => (
                ...
                >
                  ...
                  <div className="relative h-56 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                    ...
                    {/* Store Badge */}
                    <div className="absolute top-4 left-4 px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-full text-xs font-semibold shadow-sm">
                      {product.store?.name || 'Store'}
                    </div>
                    
                    {/* Commission Badge */}
                    <div className="absolute top-4 right-4 px-3 py-1.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-xs font-bold rounded-full shadow-lg">
                      Up to 40%
                    </div>
                  </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      {product.price ? (
                        <div className="text-2xl font-bold text-gray-900">₹{Number(product.price).toLocaleString()}</div>
                      ) : (
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="flex-1 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 group"
                      >
          ...
          {!loadingProducts && products.length > 0 && (
            <div className="text-center mt-12">
              <Link 
                href="/products"
                className="inline-flex items-center gap-3 px-8 py-3.5 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 text-blue-700 font-semibold rounded-xl hover:shadow-lg hover:border-blue-300 transition-all duration-300 group"
              >
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-1/2 transform -translate-x-1/2 w-3/4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="group bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-3xl p-8 hover:border-blue-300 hover:shadow-2xl transition-all duration-500">
                  {/* Step Number */}
                  <div className={`absolute -top-6 -left-6 w-16 h-16 rounded-2xl ${step.gradient} text-white flex items-center justify-center font-bold text-2xl shadow-xl animate-bounce-subtle`}>
                    {step.number}
                  </div>
                  
                  {/* Icon Container */}
                  <div className={`w-20 h-20 rounded-2xl ${step.gradient} text-white flex items-center justify-center mb-6 shadow-lg transform group-hover:scale-110 transition-transform duration-300`}>
                    {step.icon}
                  </div>
                  ...
                  {/* Progress Bar */}
                  <div className="mt-6 h-2 w-0 group-hover:w-full bg-gradient-to-r from-blue-500 to-cyan-500 transition-all duration-500 rounded-full" />
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="group bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-3xl p-8 hover:border-blue-300 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1"
            >
              <div className="flex items-start gap-6">
                <div className={`w-16 h-16 rounded-2xl ${feature.iconColor} flex items-center justify-center text-2xl transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {feature.icon}
                </div>
              ...
              <div className="mt-6 h-1 w-0 group-hover:w-full bg-gradient-to-r from-blue-500 to-cyan-500 transition-all duration-500 rounded-full" />
            </div>
          ))}
        </div>
      </div>
...
function Testimonials() {
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-yellow-500/10 to-amber-500/10 border border-amber-200/50 mb-4">
            <Star className="w-4 h-4 text-amber-600 fill-current" />
            <span className="text-sm font-semibold text-amber-700">TRUSTED BY 10,000+ AFFILIATES</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="group relative bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-3xl p-8 hover:border-blue-300 hover:shadow-2xl transition-all duration-500"
            >
              {/* Quote Mark */}
              <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white flex items-center justify-center text-2xl shadow-xl">
                "
              </div>
              ...
              <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200/50">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-cyan-300 text-white flex items-center justify-center font-bold text-lg shadow-lg">
                    {testimonial.avatar}
                  </div>
                  <div>
                ...
                <div className="text-right">
                  <div className="px-3 py-1.5 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-full inline-block">
